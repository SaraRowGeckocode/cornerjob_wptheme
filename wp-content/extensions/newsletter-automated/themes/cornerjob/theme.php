<?php 
$images_folder = home_url() .'/wp-content/extensions/newsletter-automated/themes/cornerjob/images/';
$body_width = 600;
$title_font_size = '28px';
$post_title_font_size = '22px';
//$posts_laguage = $theme_options['theme_posts_language'];
...
// ***********************************************
//		CUSTOM GET_POSTS WITH LANGUAGE FILTER
// ***********************************************
$cat = '';
					...
					<td bgcolor="<?php echo $title_background; ?>" align="center" style="padding:20px 35px"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: <?php echo $body_width - 70; ?>px; font-family: <?php echo $title_font_family; ?>; font-weight:500; font-size: 14px; color: #ffffff; width:100%;">
						<tr>
							<td width="50%" align="center" style="vertical-align:top">
								...
								<a href="https://app.adjust.com/pxwc2w" style="text-decoration:none; margin:0 5px" target="_blank"><img src="<?php echo $images_folder; ?>play-store.png" style="border:0; display:inline-block!important;" alt="Google Play" width="64" height="19"></a>
								<a href="https://app.adjust.com/1bjwmo" style="text-decoration:none; margin:0 5px" target="_blank"><img src="<?php echo $images_folder; ?>app-store.png" style="border:0; display:inline-block!important;" alt="App Store" width="64" height="19"></a>
							</td>
							<td width="50%" align="center" style="vertical-align:top"><?php echo $theme_options['theme_footer_right']; ?>
								<a href="https://webmanager.cornerjob.com/?utm_source=newsletterblog#/signup" style="text-decoration:none" target="_blank"><img src="<?php echo $images_folder; ?>computer.png" style="border:0; display:inline-block!important;" alt=""  width="37" height="24"></a>
							</td>
						</tr>
					</table></td>
				</tr>
